...
export function Overview({ subtitles, colors, overview, onPrimary }: OverviewProps) {
	return (
		<div className="subtitle-wrapper">
			{Array.isArray(subtitles)
				? subtitles.map((subtitle, i) => renderOverview(i, subtitle, colors, overview, onPrimary))
				: renderOverview(0, subtitles, colors, overview, onPrimary)}
		</div>
	);
}
