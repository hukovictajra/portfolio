...
export const blogs = [
	{
		...
		image: {
			src: "@images/blogs/metro-sweets-bakery/showcase.png",
		},
		colors: {
			navbar: "#9D8C82",
			background: "#9D8C82",
		...
		sections: [
...

			{
				...
				image: {
					src: "@images/blogs/metro-sweets-bakery/brainstorming.png",
					containerStyle: {
						width: "85%",
						lg: {
							width: "100%",
			...
			},
			{
				...
				video: {
					src: "@videos/blogs/metro-sweets-bakery/welcome-page.mp4",
				},
			},

			{
				...
				image: {
					type: "gallery",
					src: [
						"@images/blogs/metro-sweets-bakery/figma-layout.png",
						"@images/blogs/metro-sweets-bakery/figma-layout-relationships.png",
					],
				},
			},
			{
				...
				video: {
					...
					src: [
						{ src: "@videos/blogs/metro-sweets-bakery/checkout.mp4" },
						{ src: "@videos/blogs/metro-sweets-bakery/contact-us.mp4" },
					],
				},
			},
			{
				...
				video: {
					src: "@videos/blogs/metro-sweets-bakery/item-selection.mp4",
				},
			},
			{
				type: "paragraph",
				...
				image: {
					src: "@images/blogs/metro-sweets-bakery/app-on-phone.png",
					containerStyle: {
						width: "90%",
					},
				},
	...
	},
	{
		...
		image: {
			src: "@images/blogs/rajvosa-concept-store/showcase.png",
		},
		colors: {
			navbar: "#792d1b",
			background: "#923721",
		...
		sections: [
			...
			},
			{
				...
				image: {
					src: "@images/blogs/rajvosa-concept-store/sketch.png",
					containerStyle: {},
				},
			},

			{
				...
				image: {
					src: "@images/blogs/rajvosa-concept-store/laptop-view.png",
					containerStyle: {
						width: "75%",
						sm: {
							width: "100%",
			...
			},
			{
				...
				video: {
					src: "@videos/blogs/rajvosa-concept-store/walkthrough.mp4",
					containerStyle: {},
				},
			},

			{
				...
				image: {
					src: "@images/blogs/rajvosa-concept-store/meet-sarajevo.png",
					containerStyle: {
						width: "60%",
						sm: {
							width: "100%",
			...
			},
			{
				...
				image: {
					src: "@images/blogs/rajvosa-concept-store/overview.png",
					containerStyle: {
						width: "90%",
						sm: {
							width: "100%",
	...
	},
	{
		...
		image: {
			src: "@images/blogs/my-tribute-to-the-1984-winter-olympics/showcase.png",
		},
		colors: {
			navbar: "#6b8478",
			background: "#567565",
		...
		sections: [
			...
			},
			{
				...
				image: {
					type: "gallery",
					src: [
						"@images/blogs/my-tribute-to-the-1984-winter-olympics/process-original.png",
						"@images/blogs/my-tribute-to-the-1984-winter-olympics/process-b-w.png",
						{
			...
			},
			{
				...
				image: {
					src: "@images/blogs/my-tribute-to-the-1984-winter-olympics/final.png",
					containerStyle: {
						height: "40%",
						sm: {
							width: "100%",
	...
	},
	{
		...
		image: { src: "@images/blogs/melodic-mix-a-custom-print-collaboration/showcase.png" },
		sections: [
			{
				type: "paragraph",
				title: "Summary📝",
				...
				image: {
					src: "@images/blogs/melodic-mix-a-custom-print-collaboration/final.png",
					containerStyle: {
						width: "80%",
						sm: {
							width: "100%",
			...
			},
			{
				...
				image: {
					...
					src: "@images/blogs/melodic-mix-a-custom-print-collaboration/brainstorming.png",
					containerStyle: {
						width: "80%",
						sm: {
							width: "100%",
			...
			},
			{
				...
				image: {
					src: "@images/blogs/melodic-mix-a-custom-print-collaboration/artists.png",
					containerStyle: {
						width: "80%",
						sm: {
							width: "100%",
			...
			},
			{
				...
				image: {
					src: "@images/blogs/melodic-mix-a-custom-print-collaboration/songs.png",
					containerStyle: {
						width: "80%",
						sm: {
							width: "100%",
			...
			},
			{
				...
				image: {
					src: "@images/blogs/melodic-mix-a-custom-print-collaboration/hoodie.png",
				},
			},
			{
				type: "paragraph",
	...
	},
	{
		...
		image: { src: "@images/blogs/sunflower-postcard/showcase.png" },
		sections: [
			{
				type: "paragraph",
				image: {
					src: "@images/blogs/sunflower-postcard/overview.png",
					containerStyle: {
						width: "60%",
						md: {
							width: "70%",
			...
			},
			{
				...
				image: {
					src: "@images/blogs/sunflower-postcard/showcase.png",
					containerStyle: {
						lg: {
							width: "70%",
						},
	...
	},
	{
		...
		image: {
			src: "@images/blogs/custom-weekly-planner/showcase.png",
			style: {
		...
		sections: [
			{
				type: "paragraph",
				image: {
					src: "@images/blogs/custom-weekly-planner/banner.png",
					containerStyle: {
						width: "100%",
						height: "100%",
					},
			...
			},
			{
				...
				image: {
					src: "@images/blogs/custom-weekly-planner/overview.png",
					containerStyle: {
						width: "80%",
						height: "80%",
					},
